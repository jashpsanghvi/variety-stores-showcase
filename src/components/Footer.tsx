    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <div className="flex items-center mb-4">
              ...
              />
              <h3 className="text-xl font-semibold">Variety Stores</h3>
            </div>
          ...
          <div>
            ...
            <div className="mt-6">
              <Link 
                to="/contact" 
                className="bg-[#1c2e6b] hover:bg-[#243a85] text-white py-2 px-4 rounded transition-colors duration-300"
              >
                Contact Us
              </Link>
            </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-300">© {new Date().getFullYear()} Variety Stores. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
